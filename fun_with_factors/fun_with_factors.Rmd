...
```{r class_exercise-solution, echo = FALSE}
class(gapminder$continent)
```

```{r class_exercise-check, echo = FALSE}
grade_code()
```

- How many levels? What are they?

```{r levels_exercise, exercise = TRUE}

```

```{r levels_exercise-solution}
levels(gapminder$continent)
nlevels(gapminder$continent)
```

```{r levels_exercise-check, echo = FALSE}
grade_code()
```
...
```{r str_exercise-check, echo = FALSE}
grade_code()
```
...
```{r nlevels_exercise, exercise = TRUE}

```

```{r nlevels_exercise-solution}
nlevels(gapminder$country)
```

```{r nlevels_exercise-check, echo = FALSE}
grade_code()
```
...
```{r filtering_exercise, exercise = TRUE}

```
  
```{r filtering_exercise-solution}
...
```{r filtering_exercise-check, echo = FALSE}
grade_code()
```
