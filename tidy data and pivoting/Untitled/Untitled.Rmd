...
lotr
```
With the way our data are formatted, would we consider this *tidy* for our needs?

```{r tidy-format-question, echo = FALSE}
question("1. With the way our data are formatted, would we consider this *tidy* for our needs?",
